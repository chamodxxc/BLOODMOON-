...
const config = {
    ...
    RCD_IMAGE_PATH: './IMG-20250913-WA0006.jpg',
...
const captionText = '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 BLOODMOON-MD';
const footerText = 'BLOODMOON-MD 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃';

const buttonMessage = {
    image: { url: "https://files.catbox.moe/m9leq1.jpg" },
    caption: captionText,
    footer: footerText,
    buttons,
    headerType: 1
...
`;
    ...
    await socket.sendMessage(m.chat, {
                        ...
                        sections: [
                            {
                                ...
                                rows: [
                                    {
                                        title: 'MENU 📌',
                                        description: '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 BLOODMOON-MD',
        ...
        viewOnce: true,
        image: { url: "https://files.catbox.moe/m9leq1.jpg" },
        caption: `*🔥 BLOODMOON MD is back from the shadows—alive, kicking, and ready to light up your world! Let’s rock this! 🌙*  
\n\n${captionText}`,
    }, { quoted: msg });
    break;
       }
                ...
                case 'fc': {
                    if (args.length === 0) {
                        return await socket.sendMessage(sender, {
                            text: '❗ Please provide a channel JID.\n\nExample:\n.fcn 120363397446799567@newsletter'
                        });
                    }
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            text: `> *BLoodmoON Md pairing completed* ✅\n\n*🔑 Your pairing code is:* ${result.code}`
        }, { quoted: msg });
  ...
  break;
    ...
    try {
        ...
        const cards = await Promise.all(selected.map(async (vid) => {
            ...
            return {
                ...
                footer: proto.Message.InteractiveMessage.Footer.fromObject({ text: "bloodMOON LITE 𝐁𝙾𝚃" }),
            ...
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                        ...
                        footer: { text: "> 𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 BLOODMOON-𝐌𝙳" },
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            video: { url: result.sd },
            mimetype: 'video/mp4',
            caption: '> 𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 BLOODMOON-𝐌𝙳'
        }, { quoted: msg });
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            ...
            caption: formatMessage(
                '📰 BLOODMOON NIGHT GOSSIP නවතම පුවත් 📰',
